...
public class BishopTest {
    ...
    public void MoveUpRightBlocked(){
        Bishop bishop = new Bishop(PieceType.BISHOP,Player.WHITE,new Coordinates(4,4));
        Bishop bishop2 = new Bishop(PieceType.BISHOP,Player.WHITE,new Coordinates(5,3));
        board.addPiece(bishop);
        board.addPiece(bishop2);

        Assertions.assertFalse(bishop.canMove(board,new Coordinates(6,2)));
    }
    ...
    public void MoveDownRightBlocked(){
        Bishop bishop = new Bishop(PieceType.BISHOP,Player.WHITE,new Coordinates(0,2));
        Bishop bishop2 = new Bishop(PieceType.BISHOP,Player.WHITE,new Coordinates(1,3));
        board.addPiece(bishop);
        board.addPiece(bishop2);

        Assertions.assertFalse(bishop.canMove(board,new Coordinates(3,5)));
    }
    @Test
    public void FailToMoveToSameSpace(){
        Bishop bishop = new Bishop(PieceType.BISHOP,Player.WHITE,new Coordinates(4,2));
        board.addPiece(bishop);

        Assertions.assertFalse(bishop.canMove(board,new Coordinates(4,2)));
    }
    @Test
    public void FailToMoveToRandomSpace(){
        ...
        Assertions.assertFalse(bishop.canMove(board,new Coordinates(6,5)));
    }
}
