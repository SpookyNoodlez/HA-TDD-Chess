...
public class QueenTest {
    ...
    public void MoveLeftUnhindered(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,4));
    ...
    public void MoveUpUnhindered(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,5));
        board.addPiece(queen);
    ...
    public void MoveDownUnhindered(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,2));
        board.addPiece(queen);
    ...
    public void FailToTakeOwnPiece(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,2));
        Queen queen2 = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(1,2));
        board.addPiece(queen);
    ...
    public void PieceInThePathGoingLeft(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,2));
        Queen queen2 = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(2,2));
        board.addPiece(queen);
        board.addPiece(queen2);
    ...
    public void PieceInThePathGoingRight(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,2));
        Queen queen2 = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(5,2));
        board.addPiece(queen);
        board.addPiece(queen2);
    ...
    public void PieceInThePathGoingUp(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,6));
        Queen queen2 = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,4));
        board.addPiece(queen);
        board.addPiece(queen2);
    ...
    public void PieceInThePathGoingDown(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,3));
        Queen queen2 = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,4));
        board.addPiece(queen);
        board.addPiece(queen2);
    ...
    public void CaptureEnemyDown(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,3));
        Queen queen2 = new Queen(PieceType.ROOK,Player.BLACK,new Coordinates(4,5));
        board.addPiece(queen);
        board.addPiece(queen2);
    ...
    public void CaptureEnemyUp(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,5));
        Queen queen2 = new Queen(PieceType.ROOK,Player.BLACK,new Coordinates(4,3));
        board.addPiece(queen);
        board.addPiece(queen2);
    ...
    public void CaptureEnemyLeft(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,5));
        Queen queen2 = new Queen(PieceType.ROOK,Player.BLACK,new Coordinates(1,5));
        board.addPiece(queen);
        board.addPiece(queen2);
    ...
    public void CaptureEnemyRight(){
        Queen queen = new Queen(PieceType.ROOK,Player.WHITE,new Coordinates(4,5));
        Queen queen2 = new Queen(PieceType.ROOK,Player.BLACK,new Coordinates(7,5));
        board.addPiece(queen);
        board.addPiece(queen2);
